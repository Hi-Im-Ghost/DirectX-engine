...
public:
	...
	template<class V>
	static ObjectTranglesList<V> MakeTesselatedIndependentCapNormals(int longDiv)
	{
		namespace dx = DirectX;
		assert(longDiv >= 3);
		...
		// W pobliżu wiewrzchołków bazowych
