...
Surface Surface::FromFile(const std::string& name)
{
...

	{
		...
		if (bitmap.GetLastStatus() != Gdiplus::Status::Ok)
		{
			...
			throw Exceptions(__LINE__, __FILE__, ss.str());
		}
...
Surface::Exceptions::Exceptions(int line, const char* file, std::string note) noexcept
	:
	Exception(line, file),
	note(std::move(note))
{}

const char* Surface::Exceptions::what() const noexcept
{
...
const char* Surface::Exceptions::GetType() const noexcept
{
	return "Chili Graphics Exception";
}

const std::string& Surface::Exceptions::GetNote() const noexcept
{
	return note;
}
