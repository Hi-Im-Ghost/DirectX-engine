...
public:
	...
	template<class V>
	static ObjectTranglesList<V> MakeSk()
	{
		namespace dx = DirectX;
	...
	template<class V>
	static ObjectTranglesList<V> MakeIndependent()
	{
		constexpr float side = 1.0f / 2.0f;
	...
	template<class V>
	static ObjectTranglesList<V> MakeIndependentTextured()
	{
